...
\def\plaintitle{Maximizing Spread of Influence and Mitigating Overexposure in a Stochastic Social Network}
...
\numberofauthors{2}
\author{%
  \alignauthor{Hangil Chung\\
    \email{hc685@cornell.edu}}\\
  \alignauthor{Soobin Han\\
    \email{sh767@cornell.edu}}\\
}
...
\section{Data Analysis and Model Definitions}\label{sec:angel_data}
